...
<div class="relative w-screen h-screen overflow-hidden flex justify-center bg-light">
		<div class="flex flex-col mt-40 items-center">
			<div class="relative">
				<h1
					class="inset-0 text-5xl md:text-7xl xl:text-[6.5rem] font-bold text-secondary lg:translate-y-1 translate-y-0.5 opacity-50"
				>
					GrizzHacks 7
				</h1>
				<h1 class="inset-0 absolute text-5xl md:text-7xl xl:text-[6.5rem] font-bold text-primary">
					GrizzHacks 7
				</h1>
			</div>
			<form
				method="POST"
				class="w-full flex flex-col lg:flex-row text-lg lg:text-xl ring-2 ring-primary rounded-md z-50 mt-4"
			>
				<input
				...
				/>
				<button
					class="lg:w-1/4 w-full bg-primary text-white lg:rounded-bl-none rounded-b-md lg:rounded-r-md p-1 lg:p-2 font-recoleta"
					>Notify me</button
				>
			</form>
			<p class="font-recoleta opacity-60 my-1 font-medium">
				{form?.success
		...
		<div class="w-full bottom-0 absolute">
			<div class="relative">
				...
				<img
					src="water.svg"
					class="w-full -translate-y-20 scale-125 md:scale-110 sm:translate-y-10 lg:translate-y-14 xl:translate-y-28 z-30"
					alt=""
				/>
				<div class="sm:hidden absolute -bottom-1 w-full h-20 bg-primary"></div>
			</div>
			<flex class="justify-between md:mx-10 mx-2 absolute md:bottom-5 bottom-1 text-white">
				...
				<p class=" text-white md:text-lg font-recoleta">
					Looking to <a
						class="underline underline-offset-2 transition-all hover:underline-offset-4"
